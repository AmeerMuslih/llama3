...
def matmul_sa(tensor_a, tensor_b, dir_name):
	...
	os.makedirs(f'/home/a.mosa/Ameer/llama3_2/OutputFiles/{dir_name}', exist_ok=True)
	torch.save(all_util, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/{dir_name}/all_util.pt')
	torch.save(Accumulator_TOT, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/{dir_name}/Accumulator_TOT.pt')
	torch.save(InputA_TOT, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/{dir_name}/InputA_TOT.pt')
	torch.save(InputB_TOT, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/{dir_name}/InputB_TOT.pt')
	torch.save(cycles, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/{dir_name}/cycles.pt')
	#print("Cycles = ", cycles)
	#print(dut.shape)
	return dut
