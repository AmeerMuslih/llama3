...
def matmul_sa(tensor_a, tensor_b):
	...
	os.makedirs(f'/home/a.mosa/Ameer/llama3_2/OutputFiles/Group_{start_idx}', exist_ok=True)
	torch.save(all_util, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/Group_{start_idx}/all_util.pt')
	torch.save(Accumulator_TOT, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/Group_{start_idx}/Accumulator_TOT.pt')
	torch.save(InputA_TOT, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/Group_{start_idx}/InputA_TOT.pt')
	torch.save(InputB_TOT, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/Group_{start_idx}/InputB_TOT.pt')
	torch.save(cycles, f'/home/a.mosa/Ameer/llama3_2/OutputFiles/Group_{start_idx}/cycles.pt')
	#print("Cycles = ", cycles)
	#print(dut.shape)
	return dut
